plt_trend = function(dat, xvar, yvar, gpvar="1", trans_y="none") {
        # Plots the general trend removing seasonality. Usually, this means
        # to plot the residuals on the y-axis.
        #
        ...
        p = ggplot2::ggplot(dat, ggplot2::aes_string(xvar, yvar)) +
                ...
                ggplot2::geom_line(stat = "summary", fun.y = "mean", 
                                   color = red, size = size*1.5) +
